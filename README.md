...
* 🤖 **[AI Tutor using MCP + OpenAI Agents](https://github.com/huzaifa776/AI-Tutor-using-MCP-Open-AI-Agents-SDK)** - An interactive AI Tutor powered by the OpenAI Agents SDK that exposes tools (flashcards, quizzes) through a Model Context Protocol (MCP) server.
* 📝 **[AI Resume Builder](https://github.com/huzaifa776/ai-resume-builder)** - An intelligent tool powered by OpenAI GPT-4 and Google Gemini APIs that analyses, optimises, and tailors resumes to specific job descriptions while generating cover letters.
* ✈️ **[AI Travel Itinerary Planner](https://github.com/huzaifa776/Travel-Planner)** - A Gradio-based app using LangChain and Groq (Llama-3.3-70b) to generate customised, day-trip travel itineraries based on user interests.
* 🧠 **[Study Buddy AI](https://github.com/huzaifa776/study-buddy)** - An interactive application that generates dynamic quizzes and grades answers instantly using Llama and Gemini models.
* 🍽️ **[Restaurant RAG Chatbot](https://github.com/huzaifa776/restaurant-rag-chatbot)** - A context-aware Q&A chatbot built with LangChain, OpenAI embeddings, and ChromaDB to answer questions based on restaurant website data.
* 📰 **[Reasoning LLM Sentiment Analysis](https://github.com/huzaifa776/Sentiment-Analysis-using-Open-Source-Reasoning-LLM-on-News-Data)** - An end-to-end project running a quantised DeepSeek R1 reasoning LLM to analyse news dataset sentiments via a Gradio UI.
